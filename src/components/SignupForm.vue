                ...
                <div class="form-container">
                    ...
                    <form @submit.prevent="handleSubmit">
                        ...
                        <div class="form-group">
                            ...
                            <input id="password" type="password" placeholder="비밀번호를 입력해주세요" v-model="form.password"
                                required />
                        </div>
                        <div class="form-group">
                            <label for="passwordcheck">비밀번호 확인 <a style="color:red;">*</a></label>
                            <input id="passwordcheck" type="password" placeholder="비밀번호를 입력해주세요"
                                v-model="form.passwordcheck" required />
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input id="nickname" type="text" placeholder="닉네임을 입력해주세요" v-model="form.nickname"
                                required />
                        </div>
                        <div class="form-group">
